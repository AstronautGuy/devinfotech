...
const Header = () => {
    ...
    return (
        <main>
            <nav className="fixed z-20 w-full px-2 group" data-state={menuState && "active"}>
                <div
                    className={cn(
                                    ...
                                    <li key={index}>
                                        <Link
                                            ...
                                            className={`text-muted-foreground block duration-150 ${
                                                isContactPage ? "hover:text-white" : "hover:text-accent-foreground"
                                            }`}
                                        >
                                            <span>{item.name}</span>
                                        </Link>
...
const Logo = ({ className }: { className?: string }) => {
    ...
    return <TextScramble className={`text-2xl ${isContactPage ? "text-white" : ""}`}>devinfotech</TextScramble>;
};
