    ...
    return (
        <div className="w-full max-w-7xl mx-auto px-4 py-8">
            <div className="flex justify-between items-center mb-6 mt-30">
                ...
                <Link href="/admin/products/new" className="bg-blue-600 text-white font-semibold px-4 py-2 rounded-md hover:bg-blue-700">
                    + Add Product
                </Link>
            </div>
                ...
                <table className="min-w-full leading-normal">
                    ...
                    {products.map(product => (
                        <tr key={product.id}>
                            ...
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p className="text-gray-900 whitespace-no-wrap">{product.updatedAt.toLocaleDateString()}</p>
                            </td>
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm text-right space-x-2">
                                <Link href={`/admin/products/edit/${product.id}`} className="text-blue-600 hover:text-blue-900 font-semibold">Edit</Link>
